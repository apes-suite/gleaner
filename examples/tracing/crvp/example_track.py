...
fname = []
fname.append('tracking/crvp_pressCutX_l4_p00000_t0.000E+00.res')#tracking/crvp__lineX_average_l4_p00000_t0.000E+00.res')
...
get_data_for_cols = ['coordX','pressure']
sqlcon = gleaner.tracking_to_db(fname, dbname='track.db', tabname='pressure')
[x, y] = gleaner.get_columns(sqlcon, tabname='pressure',
...
resfiles = glob.glob('./tracking/*.res')
...
fig = mplt.figure()
ax = mplt.axes(xlim=(-100,100), ylim=(0.22,0.25))
...
anim.save('./pressure.mp4', writer="avconv", fps=5, bitrate=50)
mplt.show(True)
